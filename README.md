...
Жеке репозиторий: сайт `asiakoz.com`.

> Басқа жобалар: `~/Projects/erten`, `~/Projects/zhina`, `~/Projects/kese`

---

# Сайт Азиякоз — с нуля (без Tilda)

Статичный сайт офтальмологического центра Азиякоз. Только HTML и CSS, без конструкторов.
