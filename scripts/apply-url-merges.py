...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-TJ4QBS3W');</script>
  ...
  <link rel="stylesheet" href="/css/style.css" />
  <style>
    .catalog-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;margin-top:20px}
    .catalog-card{background:var(--card,#fff);border:1px solid rgba(15,23,42,.08);border-radius:14px;padding:18px 16px;box-shadow:var(--shadow)}
    .catalog-card h2{font-size:17px;margin:0 0 8px;font-weight:700}
    .catalog-card p{margin:0 0 12px;font-size:14px;line-height:1.55;color:#475569}
    .catalog-card .meta{font-size:12px;color:#64748b;margin-bottom:10px}
    .catalog-card a.btn{display:inline-flex;font-size:13px;padding:8px 14px}
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TJ4QBS3W" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <div class="container">
    ...
    <section class="section">
      <h1 class="section-title">Услуги AsiaKoz</h1>
      <p class="section-subtitle">Краткий каталог направлений. Подробности, врачи и запись — на странице услуги. Филиалы: Алматы (работает), Актау (работает), Шымкент — скоро открытие.</p>
